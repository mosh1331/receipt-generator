...
console.log(newTransaction,'==== newTransaction')
  ...
  const balance = grandTotal - totalReceived - receivedAmount;
            ...
            <div className="mt-4 relative z-10">
              ...
              <ul className="space-y-1">
                {transactions.map((t, idx) => (
                  ...
                  >
                    <span>{dayjs(t.date).format("DD MMM, hh:mm A")}</span>
                    <span>₹{t.amount}</span>
                  </li>
                ))}
              </ul>
              ...
              <table className="w-full mt-4 text-[10px] border-t border-b border-gray-300">
                <tbody>
                  <tr>
                    ...
                    <td className="text-right">₹{Number(totalReceived) + Number(receivedAmount)}</td>
                  </tr>
                  <tr>
